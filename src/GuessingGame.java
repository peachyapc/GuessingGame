...
public class GuessingGame
{
	...
	/**
	* set the upperBound for the upper number.
	* create a secret number by calling getRandomNumber
	* initialize the hint. Use: "I'm thinking of a number between 1 and 20".
	* @param upperBound = the last number you want to random until it.
	*/
	...
	*/
	...
	/**
	 * method that evaluates a guess.
	 * It also creates a hint (a String) which is saved for later.
	 * @param number is a number that user has guess.
	 * @return for check Is the number that user input is equal to a secret number or not if it not equal 
